  ...
  theme.Variants = (function() {
    ...
    Variants.prototype = Object.assign({}, Variants.prototype, {
      ...
      _onSelectChange: function({srcElement}) {
        ...
        // this.enableHistoryState is changed to FALSE forcefully, so url doesn't gets updated after vaiant is changed.
        this.enableHistoryState = false;
  ...
  theme.AjaxRenderer = (function () {
    ...
    AjaxRenderer.prototype = Object.assign({}, AjaxRenderer.prototype, {
      renderPage: function (basePath, newParams, updateURLHash = true) {
        ...
        console.log('getUpdatedParams',currentParams,newParams);
      ...
      getUpdatedParams: function (currentParams, newParams) {
        ...
        if ([...newParams.entries()].length === 0) {
            return new URLSearchParams(); // Return empty params
        }
    ...
    Drawers.prototype = Object.assign({}, Drawers.prototype, {
      ...
      open: function(evt, returnFocusEl) {
        ...
        theme.utils.prepareTransition(this.drawer, function() {
          ...
          document.body.classList.add(this.config.activeDrawer);
        }.bind(this));
      ...
      close: function(evt) {
        ...
        if (evt) {
          ...
          // Immediately toggle aria-expanded to false
        ...
        theme.utils.prepareTransition(this.drawer, function() {
          ...
          document.body.classList.remove(this.config.activeDrawer);
        }.bind(this));
  ...
  class PredictiveSearch extends HTMLElement {
    constructor() {
      ...
      document.addEventListener('predictive-search:open', e => {
        ...
        // if(document.querySelectorAll('.site-nav__link.site-nav__link--icon[aria-expanded="true"]').length > 0){
        //   document.querySelector('.site-nav__link.site-nav__link--icon[aria-expanded="true"]').click();
        // }
  ...
  theme.headerNav = (function() {
    ...
    function scrollHandler() {
      if (window.scrollY > 250) {
        ...
        console.log('navDrawerSticky::',navDrawerSticky)
        if(document.querySelector('#NavDrawer')) {
          document.querySelector('#NavDrawer').classList.add(config.navStickyClass);
        }
        ...
        if(document.querySelector('#NavDrawer')) {
          document.querySelector('#NavDrawer').classList.remove(config.navStickyClass);
        }
        if (config.wrapperOverlayed) {
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
      ...
      tagClick: function(evt) {
        ...
        const newUrl = new URL(el.href);
         ...
         console.log('newUrl before sending AJAX:', newUrl.toString());
      ...
      renderCollectionPage: function(searchParams, updateURLHash = true) {
        console.log('AJAX',window.location.pathname,searchParams,updateURLHash);
        this.ajaxRenderer
  ...
  theme.Product = (function() {
    ...
    function Product(container) {
      ...
      if (container.hasAttribute('data-quick-atc-btn')) {
        // only get the add to cart funtionality in collection product box
        this.formSetup();
        return;
      }
